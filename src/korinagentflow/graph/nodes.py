...
from korinagentflow.prompts.agent import AGENT_SYSTEM_PROMPT
from korinagentflow.core.llm_factory import get_model_for_node
from korinagentflow.core.retry import retry_llm
...
def agent_node(state: AgentState) -> dict[str, Any]:
    ...
    # 支持 KORIN_SKIP_MEMORY 环境变量用于消融实验
    skip_memory = os.environ.get("KORIN_SKIP_MEMORY", "").lower() in ("1", "true", "yes")
...
# 导入放在末尾以避免循环引用
from korinagentflow.prompts.agent import PLANNER_PROMPT, REFLECTOR_PROMPT  # noqa: E402
